...
public class User_review_rating extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String q = "/user_view_rated?did="+UserViewDesigners.dids+"&lid="+Login.logid;
        q=q.replace(" ", "%20");
        JR.execute(q);
        ...
        getRating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                JsonReq JR=new JsonReq();
                JR.json_response=(JsonResponse)User_review_rating.this;
                String q = "/user_rate_designer?did="+UserViewDesigners.dids+"&rating="+rating+"&review="+review+"&lid="+Login.logid;
                JR.execute(q);
                Log.d("pearl",q);
            }
        });
    ...
    public void response(JSONObject jo) {
        ...
        try {
            ...
            }else if(method.equalsIgnoreCase("user_rate_designer"))
            {
                try {
                    String status=jo.getString("status");
                    if(status.equalsIgnoreCase("success"))
    ...
    public void onBackPressed()
    {
        // TODO Auto-generated method stub
        super.onBackPressed();
        Intent b=new Intent(getApplicationContext(),UserViewDesigners.class);
        startActivity(b);
    }
